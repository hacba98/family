		...
		return (
			<GridContainer>
				...
				<GridItem xs={8}>
					...
					<ul>
						<li>Rada chỉ tuyển dụng đội ngũ thợ sửa tivi tay nghề cao và các trung tâm dịch vụ, bảo hành tivi có uy tín.</li>
					...
					<ul>
						...
						<li>Khiếu nại với Rada nếu cảm thấy dịch vụ sửa TV chưa tốt để chúng tôi kiểm tra và loại bỏ các nhà cung cấp dịch vụ nếu không đáp ứng chất lượng yêu cầu.</li>
